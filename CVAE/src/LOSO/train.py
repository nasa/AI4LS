...
def build_model(args, dataset, device):
    ...
    if args.pretrain_checkpoint:
        ...
        #
        # Transfer tissue embedding from pretrain — vocab matches GeneLab.
        # Skip all other condition embeddings (strain, sex, study, euth)
        # and classifier/discriminator heads — these are randomly initialized
        # and learned from GeneLab data during fine-tuning.
        transferred = []
        skipped     = []

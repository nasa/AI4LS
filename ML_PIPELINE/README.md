...
```console
python run_docker_pipeline.py --operation=download --osd_id=511 --target_column=condition --sample_column=sample --task_type=classification --algorithm=random_forest --test_size=0.2 --trans_list=nrl
```

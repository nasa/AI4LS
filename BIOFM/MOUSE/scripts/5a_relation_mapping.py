# -*- coding: utf-8 -*-
"""5a_relation_mapping.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1iXN6SjbnLBPvabC6RknBk86C-Ks83zGX
"""
...
esm2_data = torch.load("./data/embeddings/esm3_sm_open_v1_gene_embeddings.pt")
...
plt.ylabel("tSNE-2")
#plt.show()
plt.savefig("figures/kmeans-with-labels.png")
...
plt.ylabel("tSNE-2")
#plt.show()
plt.savefig("figures/hdbscan-clusters-with-labels.png")
...
#plt.show()
plt.savefig("figures/go-enrichment-per-cluster.png")
...
#plt.show()
plt.savefig("figures/go-" + str(c1) + "_vs_" + str(c2) + ".png")
...
plt.tight_layout()
#plt.show()
plt.savefig("figures/go-top-terms-per-cluster.png")
...
#plt.show()
plt.savefig("figures/kegg-pathway-count-per-cluster.png")
...
plt.gca().invert_yaxis()
#plt.show()
plt.savefig("kegg-comparison-" + str(c1) + "_vs_" + str(c2) + ".png")
...
plt.gca().invert_yaxis()
#plt.show()
plt.savefig("figures/kegg-enrichment-comparison-" + str(c1) + "_vs_" + str(c2) + ".png")
...
plt.tight_layout()
#plt.show()
plt.savefig("kegg-enrichment-top-pathways-per-cluster.png")
